...
const CustomerForm = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      axios
        .get(`https://billing-backend-wheat.vercel.app/customer/mono/${id}`)
        .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (id) {
        // Update
        await axios.put(
          `https://billing-backend-wheat.vercel.app/customer/update/${id}`,
          formData
        );
        ...
        // Add new
        await axios.post(
          "https://billing-backend-wheat.vercel.app/customer/add",
          formData
        );
